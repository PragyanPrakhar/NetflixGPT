...
const MovieDetails = () => {
    ...
    const shareMovie = () => {
        ...
        navigator.clipboard
            ...
            .then(() => {
                toast.success("Link copied to clipboard!"); // Show alert message
            })
            .catch((err) => {
    ...
    return (
        <div className="bg-gray-900 h-[200vh] text-white flex flex-col items-center ">
            {/* Movie Title */}
            ...
            <div className="mt-8 flex flex-col md:flex-row w-screen max-w-4xl">
                ...
                <div className="relative">
                    ...
                    />
                    <span
                        className={`absolute top-2 left-1 px-4 py-1 rounded-full text-sm font-semibold text-white ${
                ...
                <div className="mt-16">
                    <button
                        className="bg-blue-600 mt-10 text-white font-semibold py-2 px-4 rounded-lg shadow-lg hover:bg-blue-800 transition duration-300"
                        onClick={shareMovie}
                    >
                        <CiShare2 />
                    </button>
